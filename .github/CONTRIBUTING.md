# Contributing to ncov-open-data-ph

Love ncov-open-data-ph and want to help? Thanks so much, there's something to do for everybody!
...
The [issue tracker](https://github.com/altcoder/ncov-open-data-ph/issues) is
...
1. [Fork](https://help.github.com/articles/fork-a-repo/) the project, clone your fork, and configure the remotes:
   ...
   git clone https://github.com/<your-username>/ncov-open-data-ph.git
   # Navigate to the newly cloned directory
   cd ncov-open-data-ph
   # Assign the original repo to a remote called "upstream"
   git remote add upstream https://github.com/altcoder/ncov-open-data-ph.git
   ```
